/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 01e2b8f69ab9d01977173cd4bb5e3937)
...
declare namespace Cloudflare {
	...
	interface Env {
		ASSETS: Fetcher;
		API_URL: "https://api.garblo.workers.dev";
		VITE_API_URL: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_URL" | "VITE_API_URL">> {}
}
