    ...
    return (<section id="section3" className={styles_module_css_1.default['section-container']}>
      <div className={styles_module_css_1.default['section-wrapper']}>
        ...
        <div className={styles_module_css_1.default['image-col']}>
          ...
          <img src="https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?q=80&w=1000&auto=format&fit=crop" alt="Garment Flatlay Before" className={styles_module_css_1.default['img-before']}/>
          {/* Ảnh After (Người mẫu AI mặc chiếc áo đó) */}
          <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=1500&auto=format&fit=crop" alt="AI Generated Fashion Model" className={styles_module_css_1.default['img-after']}/>
        </div>
